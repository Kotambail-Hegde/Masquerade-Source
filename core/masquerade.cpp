...
[Window][Emulation Window (Masquerade)/##Child1_ABA40F6A]
IsChild=1
Size=525,405
...
[Window][Registers##GBCDebug]
ViewportPos=461,139
ViewportId=0xF13B4093
Pos=8,188
Size=578,398
Collapsed=0
DockId=0x00000007,0

[Window][OAM / Sprites##GBCDebug]
ViewportPos=461,139
ViewportId=0xF13B4093
Pos=8,588
Size=578,547
...
[Window][Complete Viewport##GBCDebug]
ViewportPos=461,139
ViewportId=0xF13B4093
Pos=588,188
Size=670,421
...
[Window][GBC PPU Debugger]
ViewportPos=478,227
ViewportId=0x2114C8FA
Size=1700,950
Collapsed=0

[Window][GB-GBC PPU Debugger]
ViewportPos=461,139
ViewportId=0xF13B4093
Size=1729,1143
Collapsed=0

[Window][Registers##NESDebug]
ViewportPos=425,28
ViewportId=0x3B919680
Pos=8,188
Size=567,408
Collapsed=0
DockId=0x00000015,0

[Window][Nametables##NESDebug]
ViewportPos=425,28
ViewportId=0x3B919680
Pos=577,188
Size=589,943
...
[Window][Pattern Tables##NESDebug]
ViewportPos=425,28
ViewportId=0x3B919680
Pos=1168,188
Size=562,683
...
[Window][NES PPU Debugger]
ViewportPos=425,28
ViewportId=0x3B919680
Size=1738,1139
Collapsed=0

[Window][Composite Viewport##NESDebug]
ViewportPos=425,28
ViewportId=0x3B919680
Pos=577,188
Size=589,943
...
DockSpace         ID=0xCFDD4DDB Pos=433,216 Size=1722,943 Split=X
  DockNode        ID=0x0000000F Parent=0xCFDD4DDB SizeRef=567,600 Split=Y Selected=0xAC525BE4
    DockNode      ID=0x00000015 Parent=0x0000000F SizeRef=431,449 Selected=0xAC525BE4
    DockNode      ID=0x00000016 Parent=0x0000000F SizeRef=431,586 Selected=0xF551C0A1
  DockNode        ID=0x00000010 Parent=0xCFDD4DDB SizeRef=1153,600 Split=X
    DockNode      ID=0x00000011 Parent=0x00000010 SizeRef=589,600 CentralNode=1 Selected=0xD45BFF55
    DockNode      ID=0x00000012 Parent=0x00000010 SizeRef=562,600 Split=Y
      DockNode    ID=0x00000013 Parent=0x00000012 SizeRef=247,683 Selected=0xDD85186A
      DockNode    ID=0x00000014 Parent=0x00000012 SizeRef=247,258 Selected=0xA66D74E5
DockSpace         ID=0xE7F226C9 Pos=469,327 Size=1713,947 Split=X
  DockNode        ID=0x00000002 Parent=0xE7F226C9 SizeRef=578,600 Split=Y
    DockNode      ID=0x00000007 Parent=0x00000002 SizeRef=249,398 Selected=0x7495D2ED
    DockNode      ID=0x00000008 Parent=0x00000002 SizeRef=249,547 Selected=0x2D9649A8
  DockNode        ID=0x00000004 Parent=0xE7F226C9 SizeRef=1133,600 Split=X
    DockNode      ID=0x00000005 Parent=0x00000004 SizeRef=670,600 Split=Y
      DockNode    ID=0x0000000B Parent=0x00000005 SizeRef=500,421 CentralNode=1 Selected=0x5442A268
      DockNode    ID=0x0000000C Parent=0x00000005 SizeRef=500,524 Split=Y
        DockNode  ID=0x0000000D Parent=0x0000000C SizeRef=500,268 Selected=0x80EBA47F
        DockNode  ID=0x0000000E Parent=0x0000000C SizeRef=500,254 Selected=0x2AAD78F0
    DockNode      ID=0x00000006 Parent=0x00000004 SizeRef=461,600 Split=Y
      DockNode    ID=0x00000009 Parent=0x00000006 SizeRef=247,358 Selected=0x3A5114C4
      DockNode    ID=0x0000000A Parent=0x00000006 SizeRef=247,240 Selected=0x7EAAFDEC
)";
